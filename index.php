...
<html b:css='false' b:defaultwidgetversion='2' b:layoutsVersion='3' b:responsive='true' b:templateVersion='1.3.0' expr:class='data:blog.languageDirection' expr:dir='data:blog.languageDirection' expr:lang='data:blog.localeUnderscoreDelimited' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  <head>
    ...
    <meta content='uGpCJ-Psp39V0rs0zL0JlY9aH_zwkOJUcHf0QqxXT8Q' name='google-site-verification'/>
...
})(window,document,&#39;script&#39;,&#39;dataLayer&#39;,&#39;GTM-KNMZVRB&#39;);</script>
<!-- End Google Tag Manager -->
    
 <!--- Pipara Academy All Packed SEO /-->
...
Name:        Pipara Academy - Blogger Premium Template
Version:     1.5.1.V
Author:      Pipara Academy
...
<!-- Variable definitions -->
    ...
    <Variable name="body.background" description="Theme Background Color" type="color" default="#f4f4f4" value="#f4f4f4"/>
    <Variable name="main.text.color" description="Theme Main Text Color" type="color" default="#101010" value="#101010"/>
    <Variable name="main.link.color" description="Theme Main Link Color" type="color" default="#112b3e" value="#112b3e"/>
    <Variable name="keycolor" description="Mobile Address Bar Color" type="color" default="#f4961e" value="#f4961e"/>
    <Variable name="main.button.color" description="Main Buttons Colors" type="color" default="#f4961e" value="#f4961e"/>
    ...
    <Group description="Main Menu Colors" selector="div.xXvi-mainmenuWorks">
    <Variable name="main.menu.bg" description="Main Menu Background 1" type="color" default="#e07c03" value="#e07c03"/>
    <Variable name="main.menu.bg1" description="Main Menu Background 2" type="color" default="#cdb202" value="#cdb202"/>
    <Variable name="main.menu.text.color" description="Main Menu Text Color" type="color" default="#ffffff" value="#ffffff"/>
    <Variable name="submenu.background.color" description="SubMenu Background Color" type="color" default="#ffffff" value="#ffffff"/>
    <Variable name="sub.menu.text.color" description="SubMenu Text Color" type="color" default="#3a3a3a" value="#3a3a3a"/>
    <Variable name="main.logo.text.color" description="Main Logo Text Color" type="color" default="#222222" value="#222222"/>
    </Group>
    <Group description="Top Section Colors" selector="div.xXvi-mainmenuWorks">
    <Variable name="color.section" description="Top Section Color 1" type="color" default="#e07c03" value="#e07c03"/>
    <Variable name="color.section1" description="Top Section Color 2" type="color" default="#cdb202" value="#cdb202"/>
    <Variable name="color.section.text" description="Top Section Text Color" type="color" default="#ffffff" value="#ffffff"/>
    </Group>
    <Group description="Mobile Menu Colors" selector="div.xXvi-mainmenuWorks">
    ...
    <Variable name="featured.posts.title" description="Featured Posts Title" type="color" default="#333333"  value="#333333"/>
    <Variable name="lables.buttons.color" description="Lables Buttons Color" type="color" default="#f4961e"  value="#f4961e"/>
    ...
    <Variable name="cloud.bg.color" description="Cloud Labels Color" type="color" default="#f4961e"  value="#f4961e"/>
    <Variable name="list.text.color" description="List Labels Color" type="color" default="#333333"  value="#333333"/>
    <Variable name="email.bg.color" description="Email Subscription Color" type="color" default="#0723eb"  value="#0723eb"/>
    <Variable name="email.text.color" description="Email Subscription Text Color" type="color" default="#ffffff"  value="#ffffff"/>
    </Group>
    <Group description="Footer Subscribe Form" selector="#footer-form-wrap">
    <Variable name="footer.email.title" description="Footer Email title" type="color" default="#ffffff" value="#ffffff"/>
    </Group>
    <Group description="Footer Colors" selector="div#footer-wrapper">
    <Variable name="footer.background.color" description="Footer Background  Color" type="color" default="#15202b" value="#15202b"/>
    ...
    <Variable name="footer.about.color" description="Footer About Us Color" type="color" default="#868686" value="#868686"/>
    <Variable name="footer.text.color" description="Footer Text Color" type="color" default="#d7d7d7" value="#d7d7d7"/>
    <Variable name="footer.copyright.bg" description="Footer Copyright Background Color" type="color" default="#0e151d" value="#0e151d"/>
    </Group>
    ...
    <Variable name="meta.font" description="Meta Font" type="font" family="Raleway" default="normal 400 14px $(family)"  value="normal 400 14px $(family)"/>
...
--black-color:#404040;
--hero-color:#aaaaaa;
--main-menu-bg:linear-gradient(45deg, #000000, #80fb0d);
...
--color-section: #00acee;
--color-section1: #38a480;
--color-section-text:$(color.section.text);
--bg-cards:#ffffff;
...
--footer-email-title:$(footer.email.title);
--bt-home:#f2f7fb;
--cm-count:#555555;
...
body#layout:before{content:"Pipara-Academy";font-family:Arial;position:absolute;top:20px;right:20px;z-index:1;padding:6px 14px;font-size:17px;border-radius:2px;font-weight:bold;color:#636363;background:#fdfdfd;border:1px solid #cac9c9 !important;}
...
body#layout .layout-widget-description,body#layout ul.rotating-box{display:none}
...
div#paint-category,div#tint-category1{overflow:hidden !important;}
...
body#layout #header-room1,.Super-FlexMenu{width:50%;}
...
body#layout #paint-category .widget,body#layout #tint-category1 .widget{float:left;width:49%;margin-right:1%;}
...
body#layout .footer-outer{display:flex;}
body#layout div#footer-checks-menu,body#layout div#footer-copyright{overflow:hidden!important;width:100%}
body#layout .Footer-adv{overflow:hidden !important;}
body#layout .Footer-adv div.widget{float:left !important;width:49% !important;}
...
body#layout #header-room1 > h4:after{content:' - Set Main Logo here with Dark Logo'}
body#layout #Super-FlexMenu > h4:after{content:' - Edit menu and submenu links here'}
body#layout #color-section > h4:after{content:' - Set homepage title,caption,images etc.'}
body#layout  #footer-form > h4:after{content:' - Footer Subsribe Form'}
body#layout #paint-category > h4:after{content:'  - Set different categories from here'}
body#layout #paint-category1 > h4:after{content:'  - Set different categories from here'}
body#layout #head-title1 > h4:after{content:'  - Set title for categories'}
body#layout #tint-category1 > h4:after{content:'  - Set different categories from here'}
body#layout #paint-category1 > h4:after{content:'  - Set different categories from here'}
body#layout #bottom-widget > h4:after{content:' - Bottom Featured Posts Section'}
...
body#layout #Footer-Function > h4:after{content:' - Change footer logo and caption'}
...
<b:defaultmarkup type='Common'>
    <b:includable id='widget-title'>
      <b:if cond='data:defaultTitle or data:title'>
        <b:if cond='data:widget.sectionId not in [&quot;main-ads-below&quot;, &quot;main-ads2&quot;]'>
    ...
    <b:includable id='customLang'>
      <b:switch var='data:message'>
        ...
        <b:case value='noMorePosts'/><b:if cond='data:blog.locale.language == &quot;en&quot;'>That is All<b:else/><data:messages.noResultsFound/></b:if>
      </b:switch>
    </b:includable>
    <b:includable id='textlist-content'>
        <b:if cond='data:widget.sectionId == &quot;admin&quot;'>
            <b:loop values='data:items' var='item'>
              <noscript async='async' crossorigin='anonymous' defer='defer' expr:src='data:item'/>
            </b:loop>
            <b:else/>
  ...
  <b:includable id='popular-content'>
        <div>
            ...
            <b:tag class='post-filter-inner' cond='data:widget.sectionId != &quot;sidebar&quot; or (data:i != 0 and (data:widget.sectionId == &quot;sidebar&quot;))' expr:href='data:post.url.canonical' expr:title='data:post.title ? data:post.title : data:messages.noTitle' name='a'>
              <b:tag class='post-filter-link background-layer' cond='data:i == 0 and (data:widget.sectionId == &quot;sidebar&quot;)' name='span'>
                  <b:if cond='data:post.featuredImage'>
                      <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:data-src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped , 74, &quot;1:1&quot;) : resizeImage(data:post.featuredImage , 74, &quot;1:1&quot;)'/>
            ...
            <b:tag expr:class='data:i == 0 and (data:widget.sectionId == &quot;sidebar&quot;) ? &quot;entery-category-fly&quot; : &quot;entery-category-box&quot;' name='div'>
              <b:if cond='data:i == 0'><span class='post-tag'><data:post.labels.first.name/></span></b:if>
              ...
              <div class='post-snip'>
                  <b:if cond='data:i == 0 and (data:widget.sectionId == &quot;sidebar&quot;)'>
                      <b:if cond='data:post.author.authorPhoto.image'><img class='post-author-image' expr:alt='data:post.author.name' expr:src='data:post.author.authorPhoto.image resizeImage 200'/>
                      ...
                      </b:if><span class='post-author'><data:post.author.name/></span>
                  </b:if><span class='post-date'><data:post.date/></span>
              </div>
            </b:tag>
            </b:tag>
            </b:if>
...
<b:includable id='share-box'>
    <div class='StickyBox'>
        <div class='StickyDemo'>
            ...
            <li class='facebook-f'><a class='facebook window-piki' data-height='650' data-width='550' expr:data-url='&quot;https://www.facebook.com/sharer.php?u=&quot; + data:view.url.canonical' href='javascript:;' rel='nofollow' title='Facebook'>Facebook</a></li>
            <li class='twitter'><a class='twitter window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://twitter.com/intent/tweet?url=&quot; + data:view.url.canonical + &quot;&amp;text=&quot; + data:view.title.jsEscaped' href='javascript:;' rel='nofollow' title='Twitter'>Twitter</a></li>
            <li class='whatsapp'><a class='whatsapp window-piki' data-height='650' data-width='550' expr:data-url='&quot;https://api.whatsapp.com/send?text=&quot; + data:view.title.jsEscaped + &quot; | &quot; + data:view.url.canonical' href='javascript:;' rel='nofollow' title='Whatsapp'>Whatsapp</a></li>
            <li class='telegram'><a class='telegram window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://telegram.me/share/url?url=&quot; + data:view.url.canonical + &quot;&amp;text=&quot; + data:view.title.jsEscaped' href='javascript:;' rel='nofollow' title='Telegram'>Telegram</a></li>
            <li class='pinterest'><a class='pinterest window-piki' data-height='750' data-width='735' expr:data-url='&quot;https://www.pinterest.com/pin/create/button/?url=&quot; + data:view.url.canonical + &quot;&amp;media=&quot; + data:post.featuredImage + &quot;&amp;description=&quot; + data:view.title.jsEscaped' href='javascript:;' rel='nofollow' title='Pinterest'>Pinterest</a></li>
            ...
            <li class='reddit'><a class='reddit window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://reddit.com/submit?url=&quot; + data:view.url.canonical + &quot;&amp;title=&quot; + data:view.title.jsEscaped' href='javascript:;' rel='nofollow' title='Reddit'>Reddit</a></li>
            <li class='tumblr'><a class='tumblr window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://www.tumblr.com/share/link?url=&quot; + data:view.url.canonical + &quot;&amp;title=&quot; + data:view.title.jsEscaped' href='javascript:;' rel='nofollow' title='Tumblr'>Tumblr</a></li>
            <li class='email'><a class='email window-piki' data-height='460' data-width='550' expr:data-url='&quot;mailto:?subject=&quot; + data:view.title.jsEscaped + &quot;&amp;body=&quot; + data:view.url.canonical' href='javascript:;' rel='nofollow' title='Email'>Email</a></li>
            </div>
            <div class='copy-section'>
                <span class='title'>Copy Post Link</span>
                <div class='copy-post'>
                    <input expr:value='data:blog.url.canonical' id='showlink' readonly='readonly'/><button aria-label='Copy'>Copy</button>
...
<b:defaultmarkup type='Blog'>
    <b:includable id='main' var='this'>
        ...
        <div class='xXvi-author'>
            ...
            <ul class='description-links colorful-ico social-color-hover'/>
            </div>
        </div>
        </b:includable>
        ...
        <div class='comment-form'>
            ...
            <iframe allowtransparency='allowtransparency' class='blogger-iframe-colorize blogger-comment-from-post' frameborder='0' id='comment-editor' name='comment-editor' src='' style='min-height:110px;' width='100%'/>
        ...
        <b:include cond='!data:view.isPage' data='post' name='postAuthorImage'/>
        <b:include cond='!data:view.isPage' data='post' name='postAuthor'/><b:include data='post' name='postTimestamp'/>
        </div>
        </b:includable>
        ...
        <b:if cond='data:post.author.authorPhoto.image and !data:view.isPage'>
            <img class='post-author-image' expr:src='resizeImage(data:post.author.authorPhoto.image, 70)'/>
            <b:else/><img class='post-author-image' expr:alt='data:post.author.name' src='https://4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s100/avatar.png'/>
        </b:if>
        </b:includable>
        ...
        <div class='post-filter-image' itemprop='image' itemscope='itemscope' itemtype='https://schema.org/ImageObject'>
            ...
            <b:if cond='data:post.featuredImage'>
                <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:data-src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped , 74, &quot;1:1&quot;) : resizeImage(data:post.featuredImage , 74, &quot;1:1&quot;)' itemprop='url'/>
                <b:else/>
        ...
        <b:includable id='postPaginationNext'>
           <!-- Post Pagination Index -->
              <div class='blog-pager container' id='blog-pager'>
                <b:if cond='data:olderPageUrl'>
                  <a class='blog-pager-older-link load-more' expr:data-load='data:olderPageUrl' href='javascript:;' id='lxXvi-loadmore'><b:include data='{ message: &quot;loadMorePosts&quot; }' name='translate'/></a>
        ...
        <b:if cond='data:allBylineItems.share'>
            ...
            <ul class='share-runs colorful-ico social-front-hover'>
                ...
                <li class='facebook-f'><a class='facebook window-piki' data-height='650' data-width='550' expr:data-url='&quot;https://www.facebook.com/sharer.php?u=&quot; + data:post.url.canonical' href='javascript:;' rel='nofollow' title='Facebook'>Facebook</a></li>
                <li class='twitter'><a class='twitter window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://twitter.com/intent/tweet?url=&quot; + data:post.url.canonical + &quot;&amp;text=&quot; + data:post.title' href='javascript:;' rel='nofollow' title='Twitter'>Twitter</a></li>
                <li class='whatsapp'><a class='whatsapp window-piki' data-height='650' data-width='550' expr:data-url='&quot;https://api.whatsapp.com/send?text=&quot; + data:post.title + &quot; | &quot; + data:post.url' href='javascript:;' rel='nofollow' title='Whatsapp'>Whatsapp</a></li>
        ...
        <!-- Post Timestamp -->
        <b:if cond='data:allBylineItems.timestamp'><span class='post-date published' expr:datetime='data:post.date.iso8601'><data:post.date/></span></b:if>
        </b:includable>
        ...
        <div class='all-flex'>
            ...
            <div class='post-inner-user'>
                <b:if cond='data:post.author.authorPhoto.image and !data:view.isPage'>
                <span class='author-image'><img class='snip-thumbnail' expr:data-src='resizeImage(data:post.author.authorPhoto.image, 70)'/></span>
                <b:else/><span class='author-image'><img class='snip-thumbnail' data-src='https://4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s100/avatar.png' expr:alt='data:post.author.name'/></span>
                </b:if>
            </div>
            <div class='post-inner-username'>
            <span class='post-author-times' itemprop='name'><data:allBylineItems.author.label/> <i class='far fa-user'/><data:post.author.name/></span>
        ...
        <b:if cond='data:view.isArchive'>
            ...
            <b:if cond='data:view.isError'><div class='errorPage'><h3>404</h3><h4><data:messages.theresNothingHere/></h4><p><data:navMessage/></p><a class='homepage' expr:href='data:blog.homepageUrl'><i class='fa fa-home'/><data:messages.home/></a></div></b:if>
        </b:includable>
...
<b:defaultmarkup type='Profile'>
    ...
    <b:includable id='userProfile'>
        ...
        <div class='profile-info'>
            ...
            <ul class='description-links colorful-ico social-color-hover'/>
            <div class='profile-data location'><data:location/></div>
        </div>
    </b:includable>
    ...
    <b:includable id='postContent' var='post'>
        <div class='post-content'>
            <a class='post-filter-link' expr:href='data:post.url'>
                <b:if cond='data:post.featuredImage'><img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:data-src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped , 74, &quot;1:1&quot;) : resizeImage(data:post.featuredImage , 74, &quot;1:1&quot;)'/>
                    <b:else/><img class='snip-thumbnail' data-src='https://4.bp.blogspot.com/-O3EpVMWcoKw/WxY6-6I4--I/AAAAAAAAB2s/KzC0FqUQtkMdw7VzT6oOR_8vbZO6EJc-ACK4BGAYYCw/w680/nth.png' expr:alt='data:post.title ? data:post.title : data:messages.noTitle'/>
                </b:if><b:class expr:name='data:post.featuredImage.isYouTube ? &quot;video-nos&quot; : &quot;image-nos&quot;'/>
            </a>
            <div class='entery-category'>
                <b:if cond='data:post.author.authorPhoto.image'><img class='post-author-image' expr:alt='data:post.author.name' expr:src='data:post.author.authorPhoto.image resizeImage 200'/>
                    <b:else/><img class='post-author-image' expr:alt='data:post.author.name' src='https://4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s100/avatar.png'/>
                </b:if><span class='post-author'><data:post.author.name/></span><span class='label-news-flex'><data:post.labels.first.name/></span>
                ...
                <div class='post-snip'><span class='post-date'><data:post.date/></span><span class='post-comments'><data:post.numberOfComments/> <i class='far fa-comment-alt'/></span></div>
            </div>
        </div>
    </b:includable>
</b:defaultmarkup>
...
<noscript><iframe height='0' src='https://www.googletagmanager.com/ns.html?id=GTM-KNMZVRB' style='display:none;visibility:hidden' width='0'/></noscript>
<!-- End Google Tag Manager (noscript) -->
  ...
  <div id='fb-root'/>
<script async='async' crossorigin='anonymous' defer='defer' nonce='ItQrmImy' src='https://connect.facebook.net/en_GB/sdk.js#xfbml=1&amp;version=v17.0&amp;appId=1221384711905396&amp;autoLogAppEvents=1'/>
...
<div class='admin-area' style='display:none'>
    <b:section class='admin-section' id='admin' maxwidgets='1' name='Theme Options (Admin Panel)' showaddelement='no'>
      <b:widget id='TextList15' locked='true' title='Facebook SDK (Plugin)' type='TextList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='shownum'>1</b:widget-setting>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
          <b:widget-setting name='item-0'>faacekdaiw</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main' var='this'>
          <b:include name='widget-title'/>
          <b:include name='content'/>
      ...
      <b:widget id='LinkList1' locked='true' title='Variables / Comments' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
        ...
        <b:includable id='content'><b:tag name='script' type='text/javascript'><b:loop values='data:links' var='link'><b:if cond='data:link.name == &quot;noThumb&quot;'>var noThumb = &quot;<data:link.target/>&quot;;</b:if> <b:if cond='data:link.name == &quot;commentsSystem&quot;'>var commentsSystem = &quot;<data:link.target/>&quot;;</b:if> </b:loop></b:tag></b:includable>
      </b:widget>
      <b:widget id='LinkList2' locked='true' title='Related Post / Show Texts' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
          <b:widget-setting name='text-1'>relatedPostsText</b:widget-setting>
          <b:widget-setting name='link-1'>You May Like</b:widget-setting>
          <b:widget-setting name='text-0'>loadMorePosts</b:widget-setting>
          <b:widget-setting name='link-2'>3</b:widget-setting>
          <b:widget-setting name='link-0'>Load More</b:widget-setting>
          <b:widget-setting name='text-2'>relatedPostsNum</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main'>
          <b:include name='content'/>
        </b:includable>
        <b:includable id='content'><b:tag name='script' type='text/javascript'> <b:loop values='data:links' var='link'><b:if cond='data:link.name == &quot;relatedPostsNum&quot;'>var relatedPostsNum = <data:link.target/>;</b:if> <b:if cond='data:link.name == &quot;relatedPostsText&quot;'>var relatedPostsText = &quot;<data:link.target/>&quot;;</b:if> <b:if cond='data:link.name == &quot;loadMorePosts&quot;'>var loadMorePosts = &quot;<data:link.target/>&quot;;</b:if></b:loop></b:tag></b:includable>
      </b:widget>
      <b:widget id='LinkList3' locked='true' title='Lazy Scrolls / More Text' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='link-5'>https://</b:widget-setting>
          <b:widget-setting name='link-6'>
                            https://blogging.pikitemplates.com/2021/04/documentation-of-news-blogger.html</b:widget-setting>
        ...
        <b:includable id='content'><b:tag name='script' type='text/javascript'> <b:loop values='data:links' var='link'><b:if cond='data:link.name == &quot;fixedSidebar&quot;'>var fixedSidebar = <data:link.target/>;</b:if> <b:if cond='data:link.name == &quot;fixedMenu&quot;'>var fixedMenu = <data:link.target/>;</b:if> <b:if cond='data:link.name == &quot;showMoreText&quot;'>var showMoreText = &quot;<data:link.target/>&quot;;</b:if></b:loop> </b:tag></b:includable>
      </b:widget>
    </b:section>
  </div>
<!-- Outer Wrapper -->
      ...
      <div class='container'>
        <div class='SuperLogo-wrap'>
          <div class='header-section'>
            ...
            <a class='show-menu-space' href='javascript:;'/>
           <b:if cond='data:widgets.Image any s =&gt; s.sectionId == &quot;header-room1&quot;'>
            <b:section class='header-room' id='header-room1' maxwidgets='1' name='Main Header' showaddelement='no'>
              <b:widget id='Image21' locked='true' title='B.Sc Csit RRM Campus' type='Image' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEjrbmik4efmsVXYSu4rCKPCQ59viIAIXZzD87uUv7Zvi4wO5Qs6OdZX3Xr_tr38cmdFlRD5qV_8mKTjLZDOT38l92C_-WDTOPcpAhGl4vK_KgFaz37HNV_xNPTv-mSpBevR9BBN8nSDmeyH5PacxYURBnxoNVADbAZ9CHxbvPO2gReG04e9uT3xSZqV6Q=s1600</b:widget-setting>
                  <b:widget-setting name='displayHeight'>362</b:widget-setting>
                  <b:widget-setting name='sectionWidth'>150</b:widget-setting>
                  <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
                  <b:widget-setting name='displayWidth'>1600</b:widget-setting>
                  <b:widget-setting name='link'/>
                  <b:widget-setting name='caption'>RRM Campus Janakpurdham is a renowned educational institution in Nepal offering a CSIT program. It has experienced faculty, modern facilities, and strong industry connections. The program covers programming, algorithms, networking, and software development. Graduates have high employability in IT roles</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main' var='this'>
                    <b:include name='content'/>
                  </b:includable>
                <b:includable id='content'>
                    ...
                    <b:if cond='data:link contains &quot;http&quot;'><b:tag name='script' type='text/javascript'>var darkImage = document.querySelector(&#39;#darkroom1&#39;); (localStorage.getItem(&#39;mode&#39;)) === &#39;darkmode&#39; ? darkImage.setAttribute(&quot;src&quot;, darkImage.getAttribute(&quot;data-dark&quot;)): darkImage.setAttribute(&quot;src&quot;, darkImage.getAttribute(&quot;data-normal&quot;))</b:tag></b:if>
                    <b:if cond='data:view.isHomepage'><b:if cond='data:widget.sectionId == &quot;header-room&quot;'><h1 id='title-header'><data:title/></h1></b:if></b:if>
                    </a>
                  </b:includable>
              </b:widget>
            </b:section>
            ...
            <h1 class='blog-title'><b:tag expr:href='data:blog.homepageUrl.canonical' name='a'><data:blog.title/></b:tag></h1>
              ...
              <b:section class='Super-FlexMenu' id='Super-FlexMenu' maxwidgets='1' name='Main Menu' showaddelement='no'>
                <b:widget id='LinkList12' locked='true' title='Main Menu' type='LinkList' version='2' visible='true'>
                  <b:widget-settings>
                    ...
                    <b:widget-setting name='sorting'>NONE</b:widget-setting>
                    <b:widget-setting name='link-1'>/recent</b:widget-setting>
                    <b:widget-setting name='link-2'>#</b:widget-setting>
                    <b:widget-setting name='link-12'>https://www.pikitemplates.com/2022/03/citron-blogger-template.html</b:widget-setting>
                    <b:widget-setting name='link-0'>/</b:widget-setting>
                    <b:widget-setting name='link-11'>/p/shortcodes.html</b:widget-setting>
                    <b:widget-setting name='link-10'>https://blogging.pikitemplates.com/2022/03/documentation-of-citron.html</b:widget-setting>
                    ...
                    <b:widget-setting name='link-6'>/2020/01/some-people-dream-of-success-while.html</b:widget-setting>
                    <b:widget-setting name='link-3'>#</b:widget-setting>
                    <b:widget-setting name='link-4'>#</b:widget-setting>
                    <b:widget-setting name='text-1'>Rcent Posts</b:widget-setting>
                  ...
                  <b:includable id='content'>
                    <ul id='xXvi-menuflex' role='menubar'>
                      <b:loop values='data:links' var='link'><li itemprop='name'><a expr:href='data:link.target' itemprop='url'><data:link.name/></a></li></b:loop>
                    </ul>
                  </b:includable>
                </b:widget>
              </b:section>
            ...
            <div class='header-right'>
              <div class='search-wrap'>
                <b:tag class='search-button-flex' expr:title='data:messages.search' href='javascript:;' name='a' role='button'/>
              </div>
            </div>
            <div id='search-flex'>
...
<b:if cond='data:view.isHomepage'>
  <div class='flex-section' id='mega-wrap'>
      <b:section class='color-section container' id='color-section' maxwidgets='2' name='Header-Featured' showaddelement='no'>
        <b:widget id='HTML14' locked='false' title='Responsive Ads' type='HTML' version='2' visible='false'>
          <b:widget-settings>
       ...
       <div class='widget-content'><data:content/></div>
        ...
        <b:widget id='HTML1' locked='false' title='Ad' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'/>
          </b:widget-settings>
          <b:includable id='main'>
  ...
  <div class='widget-content'>
    <data:content/>
      ...
      <svg id='color-wave' version='1.1' viewBox='0 0 1440 126' x='0px' xml:space='preserve' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' y='0px'><path class='st0' d='M685.6,38.8C418.7-11.1,170.2,9.9,0,30v96h1440V30C1252.7,52.2,1010,99.4,685.6,38.8z'/></svg>
      </div>
  </div>
...
<div class='flex-section' id='home-ads'>
  <b:section class='main-ads-pikihome container' id='main-ads1' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
    <b:widget id='BlogSearch1' locked='false' title='Search Notes and Books' type='BlogSearch' version='2' visible='true'>
      <b:includable id='main' var='this'>
        <b:include name='widget-title'/>
        <b:include name='content'/>
    </b:includable>
      <b:includable id='content'>
        <div class='widget-content' role='search'>
            <form class='search-form' expr:action='data:blog.searchUrl'>
                <b:attr cond='not data:view.isPreview' name='target' value='_top'/>
                <b:include name='urlParamsAsFormInput'/>
                <input autocomplete='on' class='search-input' expr:aria-label='data:messages.searchThisBlog' expr:placeholder='data:messages.searchThisBlog' expr:value='data:view.isSearch ? data:view.search.query.escaped : &quot;&quot;' name='q'/>
                <input class='search-action' expr:value='data:messages.search.escaped' type='submit'/>
            </form>
        </div>
    </b:includable>
...
<!-- Featured Highlighted Categories -->
  <b:section class='head-title container' id='head-title1' maxwidgets='1' name='Header Posts' showaddelement='no'>
    <b:widget id='Text3' locked='true' title='Department of B.Sc CSIT RRM Campus Janakpurdham' type='Text' version='2' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='content'>Here You will Get latest Post, Books, Notes, News all Control By Pipara Academy</b:widget-setting>
      </b:widget-settings>
      <b:includable id='main'>
      <b:include name='widget-title'/>
  ...
  <b:section class='paint-category container' id='paint-category' maxwidgets='12' name='Featured Category' showaddelement='no'>
    <b:widget id='Image1' locked='true' title='B.Sc Csit' type='Image' version='2' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEh12Y1jMFMKThUnenvVtrudE2UkRMdC1WBEnh1vIyhZAfjX3Yk4C-2n6yrpmJJkU_tvmsuhEbRPEALlz9lvQtokMujw5txHeP0s5gbJFnwQi_9GYo7sD5yhxb3e3X8qMQ-R4wA1z5_TkB1JbG0_o_kpBHk6pGSX3nwcLaZitE2WYMeo6caQImSE1gg2Qw=s96</b:widget-setting>
        <b:widget-setting name='displayHeight'>96</b:widget-setting>
        <b:widget-setting name='sectionWidth'>150</b:widget-setting>
        <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
        <b:widget-setting name='displayWidth'>96</b:widget-setting>
        <b:widget-setting name='link'>http://www.akthakur.com.np/search/label/database-management-system</b:widget-setting>
        <b:widget-setting name='caption'><![CDATA["Exploring the realms of technology with BSc CSIT!" "Unleashing the power of coding and innovation through BSc CSIT." "Building a foundation in computer science and IT with BSc CSIT." "Embracing the digital future with BSc CSIT." "Empowering minds to shape the world of technology with BSc CSIT." "Mastering the art of problem-solving and programming with BSc CSIT." "Unlocking endless possibilities with a degree in BSc CSIT." "Transforming passion for technology into a successful career with BSc CSIT." "From algorithms to artificial intelligence, BSc CSIT covers it all!" "Join the next generation of tech leaders with BSc CSIT." The Computer Science and Information Technology (CSIT) program is a comprehensive and multidisciplinary field of study that combines principles of computer science with the practical applications of information technology. This field focuses on the design, development, implementation, and management of computer systems and software.  In the CSIT program, students gain a strong foundation in computer science fundamentals, including programming languages, algorithms, data structures, database management, networking, and operating systems. They also learn about emerging technologies, such as artificial intelligence, machine learning, cloud computing, and cybersecurity.  The CSIT curriculum is designed to equip students with both theoretical knowledge and practical skills. Students engage in hands-on projects, coding exercises, and real-world applications to enhance their problem-solving abilities and critical thinking skills. They learn to analyze complex problems, develop innovative solutions, and apply their knowledge to various industries, including software development, data analysis, cybersecurity, and IT consulting.  Furthermore, CSIT emphasizes the importance of teamwork and collaboration. Students often work in groups to complete projects, fostering effective communication skills and teamwork dynamics. This collaborative approach prepares students for the collaborative nature of the IT industry.  Upon completion of the CSIT program, graduates have a wide range of career opportunities available to them. They can pursue roles such as software developer, systems analyst, database administrator, network engineer, cybersecurity specialist, IT project manager, and more. Additionally, some graduates may choose to further their education by pursuing advanced degrees or certifications in specialized areas of computer science and information technology.  In summary, the CSIT program provides a comprehensive education in computer science and information technology, equipping students with the knowledge, skills, and experience necessary to thrive in the ever-evolving digital world]]></b:widget-setting>
      </b:widget-settings>
      <b:includable id='main' var='this'>
        <b:include name='content'/>
      </b:includable>
      <b:includable id='content'>
            <a class='paint-title' expr:href='data:link'>
                ...
                <div class='paint-category-title'><h2><data:title/></h2></div>
            </a>
            </b:includable>
    </b:widget>
    <b:widget id='Image2' locked='true' title='Tu Notice' type='Image' version='2' visible='true'>
      <b:widget-settings>
        <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEhZKuOJ1oXuLBcgZi_o_n46sYClAVCZI6vPWlE6PmKT5ZGCxLYdzsC0LzS2KO5a0fBtvUZDo-O6kbGeBSu7FDFppEdYWHt8XiVUiE6rMah8a1l7oDv6cfHDrhslGjhyO_TADVMiYblrHymyHVLAzsHIs-8QkKNPkOtZBq_XZJNULyqvSeun3nth_QwD7w=s96</b:widget-setting>
        <b:widget-setting name='displayHeight'>96</b:widget-setting>
        <b:widget-setting name='sectionWidth'>150</b:widget-setting>
        <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
        <b:widget-setting name='displayWidth'>96</b:widget-setting>
  ...
  <div class='flex-section' id='mega-flex'>
    <b:section class='paint-category container' id='paint-category-2' maxwidgets='12' name='Featured Category' showaddelement='no'>
      <b:widget id='Image14' locked='false' title='Education' type='Image' version='2' visible='true'>
        <b:widget-settings>
      ...
      <b:widget id='Image15' locked='true' title='News Updates' type='Image' version='2' visible='true'>
        <b:widget-settings>
      ...
      <b:widget id='Image16' locked='true' title='Game' type='Image' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEjvA06y6Ihb7f3JCvClhQ0uzJSOguGJVtDbyyM2J4d9jG_yHigfohNPpmsKS5S81UNSwxM9Q1m4_ER4OE41xK77PDYKJAG4ke4pSa2FxFyeT3isaKnlu1GK6DUnd9-IaHYFOJK859_znGRZLlxpAlcOES4_hg7x69-Kw9AyuY6GyhIawvMZ6TEImgH2nw</b:widget-setting>
          <b:widget-setting name='displayHeight'>128</b:widget-setting>
          <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      ...
      <b:widget id='Image17' locked='true' title='Google Lab' type='Image' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEh-u0bSsyZRJwFuEl2LCPCt8DhxzjLtyrsk84HjdAufg_5sHi-Y_NLp_KOpti-VndB9l5wi963fR2c-0Lji0G9Bpoi79grF2nbMzaBNe-_9Fch7CCOAuJtw59yRCCB2NTkq8YEH9OGBON-nybgchyTocMtY5ayMq0U2pbAgXPnQvRzBkbpMN5QJ-n22xw</b:widget-setting>
          <b:widget-setting name='displayHeight'>128</b:widget-setting>
          <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      ...
      <b:widget id='Image18' locked='true' title='Experiments' type='Image' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEg-WxNHaSHHoQESx64l9WsyrJ0s_5iR6Z_UkjoLWgdOe9pdim2q5rXicRw-r2oRcbKvraYdVq2QYMojRxYh3tKifiVjRpEo42HvETDDSitVsXq0a18Vjp89fiBALL1oXYhz-DGVzHpCHUMzRL65awFj8aMfwJY5BdibTwOoEKOW2C2E33Nc4y6Z4gG8Ig</b:widget-setting>
          <b:widget-setting name='displayHeight'>128</b:widget-setting>
          <b:widget-setting name='sectionWidth'>150</b:widget-setting>
      ...
      <b:widget id='Image19' locked='true' title='Products' type='Image' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEjlWPM9PkJjhPmVcjOHfvrL8icybfpUWhlImqGzFg2wDwi0Ex1tVkq1fzSvFdwi874qnIYrd1WAAcyprWj1CRfoBMM_GyU9aSduzJ4qfS6CaMESDKHkmEqnRmlbKTjE6hhn-B953fAB6ZQSqOzodCYFGHWvirT3mWhP9HwnxcjXw83i0v09EFq73ASdmQ</b:widget-setting>
          <b:widget-setting name='displayHeight'>82</b:widget-setting>
          <b:widget-setting name='sectionWidth'>150</b:widget-setting>
...
<div class='flex-section' id='center-container'>
  ...
  <div class='container outer-container'>
    <main id='feed-view'>
      <!-- Main Wrapper -->
      <b:section class='main' id='main' maxwidgets='2' name='Main Recent Posts' showaddelement='yes'>
        <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
          ...
          <b:includable id='postBody' var='post'>
            <!-- Post Body Entry Content-->
            <div class='post-body entry-content' id='postBody'><data:post.body/>
            </div>
          </b:includable>
          <b:includable id='postBodySnippet' var='post'>
            <b:include data='post' name='postBody'/>
...
&lt;/div&gt;
      ...
      <b:if cond='data:view.isPost or data:view.isLayoutMode'>
        <div id='main-ads-post'>
          <b:section class='main-ads-pikihome' id='main-ads-below' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
            <b:widget id='HTML7' locked='true' title='Ads Section' type='HTML' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'/>
              </b:widget-settings>
              <b:includable id='main'>
    ...
    <b:if cond='data:view.isPost or data:view.isLayoutMode or data:view.isPage or data:view.isError'>
    ...
    <aside id='sidebar-container' itemscope='itemscope' itemtype='https://schema.org/WPSideBar' role='banner'>
      <b:section class='sidebar' id='sidebar' name='Sidebar Right' showaddelement='yes'>
        <b:widget id='HTML23' locked='true' title='(sibForm) #title=(Follow by Email) #caption=(Get Notified About Next Update Direct to Your inbox)' type='HTML' version='2' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'/>
          </b:widget-settings>
          <b:includable id='main'>
          ...
          <b:includable id='content'>
            <b:if cond='data:title contains &quot;(sibForm)&quot;'>
              <b:class name='sibForm'/>
            </b:if>
            <div class='widget-content' expr:data-shortcode='data:title'>
              <div class='follow-by-email'>
                <b:if cond='data:title contains &quot;title&quot; and data:title contains &quot;caption&quot;'>
                  <h3 class='follow-by-email-title'/>
                  <span class='follow-by-email-caption'/>
                  <b:else/>
                ...
                <form expr:action='data:content' expr:onsubmit='&quot;window.open(\&quot;&quot;+ data:content + &quot;\&quot;,\&quot;popupwindow\&quot;,\&quot;scrollbars=yes,width=550,height=520\&quot;);return true&quot;' method='post' name='sib-subscribe-form' novalidate='' target='popupwindow'>
        ...
        <b:widget id='LinkList77' locked='true' title='Social Plugin' type='LinkList' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='link-3'>#</b:widget-setting>
            <b:widget-setting name='sorting'>NONE</b:widget-setting>
          ...
          <b:includable id='content'>
            <div class='widget-content'>
              <ul class='socialFilter colorful social'>
                ...
                <li><a expr:class='data:link.name' expr:href='data:link.target' expr:title='data:link.name' rel='noopener noreferrer' target='_blank'><data:link.name/></a></li>
                </b:loop>
              </ul>
            </div>
          </b:includable>
...
<div class='flex-section' id='footer-form-section'>
<b:section class='footer-form container' id='footer-form' maxwidgets='1' name='Footer Form' showaddelement='no'>
  <b:widget id='HTML21' locked='true' title='(sibForm)' type='HTML' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<script src="https://apis.google.com/js/platform.js"></script>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
    <b:include name='content'/>
    </b:includable>
    ...
    <div class='widget-content' expr:data-shortcode='data:title'>
        ...
        <b:if cond='data:title contains &quot;title1&quot; and data:title contains &quot;caption1&quot;'>
      <h3 class='footer-email-title'/>
      <span class='footer-email-caption'/>
      <b:else/>
      <h3 class='footer-email-title'>
  ...
  <div class='footer-email-inner'>
      <form expr:action='data:content' expr:onsubmit='&quot;window.open(\&quot;&quot; + data:content + &quot;\&quot;, \&quot;popupwindow\&quot;, \&quot;scrollbars=yes,width=550,height=520\&quot;); return true&quot;' method='post' name='sib-subscribe-form' novalidate='' target='popupwindow'>
        <input class='follow-by-email-address' name='EMAIL' placeholder='Email Address' type='email' value=''/>
        <span class='bt-footer'><i class='fab fa-telegram-plane'/><button class='follow-by-email-submit'>Submit</button></span>
      </form>
      <div class='Follow-by-alert'>* We promise that we don&#39;t spam !</div>
    </div>
  </div>
...
<div class='flex-footer' id='footer-wrapper' itemscope='itemscope' itemtype='https://schema.org/WPFooter' role='banner'>
    <div class='flex-ft footer-data'>
        <div class='container'>
        <b:section class='Footer-adv' id='Footer-Function' maxwidgets='3' name='Footer About Us' showaddelement='yes'>
          <b:widget id='Image150' locked='false' title='About Us' type='Image' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEjaV7tbGald2U7aobAxTeUKP5NFJxAWNXxoDzpndNvyPzw3YCzPBqKw-LpuHuvDUvcDmDihtSbeOo3H6vMPd66zwVC9YlJ_t3MzNPt7_c0O6PzQHwGCivBB3MV_aLgZWd0L1XeWXbH8yWnHt9q9nBO2rERZpG1foxTL6oX8LQqS_OWFJu40Rs6v26ye3g=s1600</b:widget-setting>
              <b:widget-setting name='displayHeight'>362</b:widget-setting>
              <b:widget-setting name='sectionWidth'>150</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>1600</b:widget-setting>
            ...
            <b:includable id='content'>
            <div class='widget-content'>
                <b:if cond='data:link == &quot;hide-image&quot;'><b:class name='no-image'/></b:if>
                <div class='about-content'>
                    <b:if cond='data:link != &quot;hide-image&quot;'>
                    <div class='footer-logo custom-image'><a expr:href='data:blog.homepageUrl'><img expr:alt='data:blog.title' expr:height='data:height' expr:id='data:widget.instanceId + &quot;_img&quot;' expr:src='data:sourceUrl' expr:width='data:height'/></a></div>
                    </b:if>
                    <div class='bio-data'>
          ...
          <b:widget id='LinkList7' locked='true' title='Follow Us' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://www.pikitemplates.com/</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-4'>https://www.pikitemplates.com/</b:widget-setting>
              ...
              <b:widget-setting name='link-2'>https://www.pikitemplates.com/</b:widget-setting>
            ...
            <div class='widget-content'>
                ...
                <b:loop values='data:links' var='link'><li expr:class='data:link.name'><a expr:class='data:link.name' expr:href='data:link.target' rel='noopener noreferrer' target='_blank'/></li></b:loop>
                </ul>
            </div>
            </b:includable>
          </b:widget>
    ...
    <div class='flex-ft footer-container'>
        ...
        <b:section class='footer-copyright' id='footer-copyright' maxwidgets='1' name='Footer Attribution' showaddelement='no'>
          <b:widget id='HTML33' locked='true' title='Footer Copyright' type='HTML' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[Distributed by <a href='https://rrmcsit.blogspot.com/' rel='dofollow'>Department of B.Sc Csit RRM Campus Janakpurdham</a>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
            <div class='widget-content'><span class='copyright-text widget'>Design by - <a href='https://rrmcsit.blogspot.com/' id='pikitemplates' rel='dofollow'>Amresh Thakur (Beyonlink)</a> |  <data:content/></span></div>
            </b:includable>
          </b:widget>
        </b:section>
...
<b:include cond='data:view.isPost' name='share-box'/>
  <!-- Slider Mobile Menu -->
<div id='menu-space'>
    <div class='area-runs'><span class='hide-xXvi-mainmenu'/></div>
    <div class='menu-space-flex'>
        <div class='xXvi-mainmenu' id='xXvi-mainmenu'/>
        <div class='social-mobile'/>
    </div>
</div>
<div class='overlay'/>
<div class='backTop'/>
<!--Pipara Academy Hosted Plugins -->
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js' type='text/javascript'/>
<b:include name='theme-js'/>
<!--Pipara Academy LocalHost Plugins -->
